...
const queryContact = new Parse.Query('Contact');
const contact = await queryContact.get("ke071EOSfE",{useMasterKey:true});
console.log(contact);
const address = contact.get("address");

// if(address===undefined){
//   console.log('nao tem address');
// }else{
//   console.log('TEM address');
//   address.destroy({useMasterKey:true});
// //   await address.fetch();
// //   console.log(address);
// // const title = address.get("cep");
// }

// const contact = new Parse.Object('Contact');
// contact.set('name','jsc2');
// const address = new Parse.Object('Address');
// address.id = "FkxQESGPP5";
